...
<!-- contact form -->
<form id="form1" name="form1" class="form-horizontal" action="{{URL::to('/admin-dashboard')}}" method="post">
        ...
        <div class="home-section">
            ...
            <div class="fullpage-section">
                ...
                <div
                    ...
                    <h2 class="title-with-border">Quản Lý chức năng <span class="highlight">admin</span></h2>
                    <!-- content -->
                    <div class="content">
                        <p class="desc">
                        ...
                        <div class="contact-form-container col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div id="frmlogin" class="col-lg-offset-2 col-md-offset-2 col-lg-8 col-md-8 col-xs-12">
                                <div class="form-row">
                                    <input id="username" name="admin_username" class="contact-name load-virtual-keyboard"
                                           placeholder="Tên đăng nhập" type="text" value="" maxlength="50"
                                           autocomplete="new-password">
                                </div>
                                <div class="form-row">
                                    <input id="password" name="admin_password" class="contact-email load-virtual-keyboard"
